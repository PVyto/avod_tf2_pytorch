def return_cfg(**kwargs):
    ...
    evaluation_interval = kwargs.get('evaluation_interval', 1)
    gradient_accumulations = kwargs.get('gradient_accumulations', 16)
    ...
    clip_gradient = kwargs.get('clip_gradient', False)
    ...
    rpn_detector_type = kwargs.get('rpn_type', 'conv')
    ssd_type = kwargs.get('ssd_type', 'conv')
    ...
    default_config = {
        ...
        'dataset_config': {
            ...
            # 'anchor_sizes': [0.818, 0.628, 1.768, 1.771, 0.57, 1.723],
            'mini_batch_size': 512,
